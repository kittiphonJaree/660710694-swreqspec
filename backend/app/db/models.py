...
class Slot(Base):
    """รองรับ FR-BKG-01 และ FR-BKG-04 ด้วยข้อมูลโควตาของช่วงเวลา."""
...
class Booking(Base):
    """รองรับ FR-BKG-02, FR-BKG-04 และ IF-HIS-01 โดยเก็บเฉพาะ HN."""
...
class AuditLog(Base):
    """รองรับ DOM-PDPA-01 ด้วยผู้เข้าถึง เวลา และรหัสผู้รับบริการ."""
